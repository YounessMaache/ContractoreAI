      ...
      <div className="space-y-6">
        ...
        <section className="bg-white rounded-lg p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            ...
            <button onClick={addLineItem} className="px-3 py-1 bg-blue-600 text-white rounded-lg text-sm flex items-center gap-1">
          ...
          <div className="space-y-3">
            {lineItems.map((item) => (
              <div key={item.id} className="flex gap-2 items-start">
                ...
                <button onClick={() => removeLineItem(item.id)} className="p-2 text-red-600 hover:bg-red-50 rounded-lg">
